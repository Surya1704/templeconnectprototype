...
const Mooshak: React.FC = () => {
  ...
  // Track click for optional sparkle effect
    ...
    <>
      ...
      >
        ...
        >
          <div className="w-full h-full relative">
            ...
            {/* Mouse SVG with improved details */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            ...
            {/* Animated "tail" with better animation */}
            <motion.div
      ...
      <AnimatePresence>
        {clickPosition && (
          ...
          >
            <div className="w-8 h-8 bg-spiritual-gold/30 rounded-full blur-md"></div>
            <div className="absolute inset-0 w-6 h-6 left-1 top-1 bg-white/50 rounded-full blur-sm"></div>
          </motion.div>
        )}
      </AnimatePresence>
    </>
